...
CmdletsToExport = 'Add-AzSqlDatabaseToFailoverGroup', 'Add-AzSqlElasticJobStep', 
               ...
               'Restore-AzSqlInstanceDatabase', 'Restore-AzSqlServer', 
               'Resume-AzSqlDatabase', 'Set-AzSqlDatabase', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Improved parameter validation for the EnableSoftDelete and SoftDeleteRetentionDays parameters.
