...
FunctionsToExport = 'Add-AzStackHCIVMAttestation', 'Disable-AzStackHCIAttestation', 
               ...
               'Get-AzStackHciCluster', 'Get-AzStackHciDeploymentSetting', 
               'Get-AzStackHciEdgeDevice', 'Get-AzStackHciExtension', 
               'Get-AzStackHCILogsDirectory', 'Get-AzStackHCIRemoteSupportAccess', 
               'Get-AzStackHCIRemoteSupportSessionHistory', 
               'Get-AzStackHciSecuritySetting', 'Get-AzStackHciUpdate', 
               'Get-AzStackHciUpdateRun', 'Get-AzStackHciUpdateSummary', 
               ...
               'Remove-AzStackHciSecuritySetting', 'Remove-AzStackHciUpdate', 
               'Remove-AzStackHciUpdateRun', 'Remove-AzStackHciUpdateSummary', 
               'Remove-AzStackHCIVMAttestation', 'Set-AzStackHCI', 
               'Set-AzStackHciDeploymentSetting', 'Set-AzStackHciEdgeDevice', 
               'Set-AzStackHciSecuritySetting', 'Set-AzStackHciUpdate', 
               'Set-AzStackHciUpdateRun', 'Set-AzStackHciUpdateSummary', 
               'Test-AzStackHciEdgeDevice', 'Unregister-AzStackHCI', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Modified the Cluster Registration to use Managed Service Identity instead of AAD App based registration for new OS versions.'
