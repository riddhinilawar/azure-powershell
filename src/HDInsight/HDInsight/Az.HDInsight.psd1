...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added two parameters ''-EntraUserIdentity'' and ''-EntraUserFullInfo'' to cmdlet ''New-AzHDInsightCluster'' to support create cluster with entra user as gateway credential to replace use username and password.
